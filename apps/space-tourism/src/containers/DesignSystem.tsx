...
const DesignSystem: React.FunctionComponent<DesignSystemProps> = () => {
    return (
        <div className='container'>
            ...
            <section id='typography' style={{ margin: "4rem 0" }}>
                ...
                <div className='flex'>
                    <div style={{ flexBasis: "100%" }} className='flow'>
                        <div>
                    ...
                    <div style={{ flexBasis: "100%" }} className='flow'>
                        ...
                        <div>
                            <p className='text-accent'>
                                Subheading 2 - Barlow Condensed Regular - 14px -
                                2.35 Character Space
                            </p>
                        ...
                        <div>
                            <p className='text-accent'>
                                Nav Text - Barlow Condensed Regular - 16px - 2.7
                                Character Space
                            </p>
